...
const Manchester: React.FC = () => (
  <LocationPageTemplate
    ...
    seoDescription="Professional SIA-licensed security guards, door supervisors and manned guarding in Manchester. Covering the city centre, Spinningfields, Salford Quays and all surrounding areas. Call 07585690268."
    seoCanonical="https://www.md-securityservices.co.uk/areas/manchester"
    heroImage="/assets/hero-bg.jpg"
    intro="MD Security Services provides professional, SIA-licensed security personnel across Manchester city centre and Greater Manchester — from door supervision at Deansgate venues to manned guarding at Trafford Park industrial sites."
