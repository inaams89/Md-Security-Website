...
const Rochdale: React.FC = () => (
  <LocationPageTemplate
    ...
    seoDescription="Professional security guards, door supervisors and manned guarding in Rochdale. Covering Rochdale town centre, Heywood, Middleton and surrounding areas. Call 07585690268."
    seoCanonical="https://md-securityservices.co.uk/areas/rochdale"
    heroImage="/assets/hero-bg.jpg"
    intro="MD Security Services provides professional security guards and door supervisors across Rochdale, Heywood, Middleton and the wider Rochdale borough."
