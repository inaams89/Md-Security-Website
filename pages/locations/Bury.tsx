...
const Bury: React.FC = () => (
  <LocationPageTemplate
    ...
    seoDescription="Professional SIA-licensed security guards, door supervisors and manned guarding in Bury. Covering Bury town centre, Radcliffe, Prestwich, Whitefield and surrounding areas. Call 07585690268."
    seoCanonical="https://www.md-securityservices.co.uk/areas/bury"
    heroImage="/assets/hero-bg.jpg"
    intro="MD Security Services provides reliable SIA-licensed security officers, door supervisors and event security across Bury, Radcliffe, Prestwich, Whitefield and the wider Bury borough."
