...
const FEATURES = [
  ...
  { icon: 'fa-id-badge', title: 'SIA Licensed Staff', desc: 'All event security personnel hold current SIA Door Supervisor or Security Guard licences.' },
...
const EventSecurity: React.FC = () => (
  <ServicePageTemplate
    ...
    seoDescription="Professional event security for concerts, festivals, corporate events and private functions across Manchester, Oldham and the North West. SIA licensed. Call 07585690268."
